...
/**
 * File: kiryuu.php
 * Deskripsi: Modul scraper untuk situs Kiryuu (kiryuu.id).
...
define('KIRYUU_BASE_URL', 'https://kiryuu.id');
...
/**
 * Mengambil daftar komik terbaru dari halaman utama Kiryuu.
 *
 * @return array Daftar komik dengan format [['title', 'url', 'thumbnail'], ...].
 */
function get_latest_comics(): array
{
    $html = fetch_page_content(KIRYUU_BASE_URL);
    if (!$html) {
        return [];
    }
